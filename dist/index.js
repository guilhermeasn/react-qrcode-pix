...
var import_react_qrcode_pretty = require("react-qrcode-pretty");
var Component = class extends import_react.default.Component {
  render() {
    return import_react.default.createElement(this.props.qrcodeType === "canvas" ? import_react_qrcode_pretty.QrcodeCanvas : import_react_qrcode_pretty.QrcodeSVG, {
      ...this.props.settings,
...
// src/index.ts
__reExport(index_exports, require("react-qrcode-pretty"), module.exports);
...
function PixCanvas({
  ...
  try {
    return import_react2.default.createElement(Component, {
